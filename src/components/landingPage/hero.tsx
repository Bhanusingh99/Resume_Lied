    ...
    <>
      ...
      <div className="relative min-h-screen bg-neutral-900">
        ...
        <motion.div
          ...
          className="absolute top-20 left-20 w-64 md:w-96 h-64 md:h-96 bg-purple-500/10 rounded-full blur-3xl"
        />
          ...
          >
            <div className="flex flex-col items-center text-center space-y-6 md:space-y-10">
              <motion.div variants={itemVariants} className="relative">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-800/80 border border-neutral-700/50 backdrop-blur-xl">
                  <span className="flex items-center gap-1">
                    <Sparkles className="w-3 h-3 md:w-4 md:h-4 text-purple-500" />
                    <span className="text-purple-500 text-xs md:text-sm font-semibold">
                      New
                    </span>
                  </span>
              ...
              >
                <motion.button className="px-6 sm:px-8 py-3 sm:py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-semibold flex items-center justify-center gap-2 transition-all shadow-lg w-full sm:w-auto">
